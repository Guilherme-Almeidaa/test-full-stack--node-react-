...
route.post('/register', middleware.checkFieldsIsEmptyMiddleware, employeeController.insert);
route.put('/update/:id', middleware.checkFieldsIsEmptyMiddleware, employeeController.update);
